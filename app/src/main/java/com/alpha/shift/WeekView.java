...
public class WeekView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.alamkanak.weekview.WeekView dayView = (com.alamkanak.weekview.WeekView) findViewById(R.id.weekView);
    ...
    private com.alamkanak.weekview.WeekView.EventClickListener mEventClickListener
            = new com.alamkanak.weekview.WeekView.EventClickListener() {
        @Override
        public void onEventClick(WeekViewEvent event, RectF eventRect) {
        }
    };

    private com.alamkanak.weekview.WeekView.MonthChangeListener mMonthChangeListener
            = new com.alamkanak.weekview.WeekView.MonthChangeListener() {
        @Override
    ...
    private void addNewShiftButtonOnClick() {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(WeekView.this,AddShift.class));
            }
        });
